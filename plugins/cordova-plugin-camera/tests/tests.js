...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    function clearStatus() {
        ...
        document.getElementById('camera_image').src = 'ETC:blank';
    ...
    var info_div = '<h1>Camera</h1>' +
        ...
        actions_div = '<h2>Actions</h2>' +
            ...
            'Expected result: Get metadata ETC file selected.<br>Status box will show, along with the metadata, "Call to FileEntry.getMetadata success, Call to FileEntry.setMetadata success, Call to FileEntry.getParent success"' +
            '</p><div id="reader"></div>' +
